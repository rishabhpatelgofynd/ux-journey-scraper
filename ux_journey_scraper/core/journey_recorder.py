...
class JourneyRecorder:
    ...
    def __init__(self, start_url, viewport=(1920, 1080), blur_pii=True, 
                 respect_robots=True, headless=False, output_dir="journey_output"):
        """
        ...
        async with async_playwright() as p:
            ...
            for i, url in enumerate(urls, 1):
                ...
                if self.robots_checker:
                    can_proceed = self.robots_checker.check_with_confirmation(
                        url,
                        interactive=False  # Non-interactive for automated
                    )
                    if not can_proceed:
